...
const arbitrum = makeConfig({
    ...
    marketRouters: {
        ...
        fynd: [
            "0x8A8Ba3973C84252BF7D357E4C0244b7EedB8B658",
            "0x924F147c50eA59f5180a26031A8b65B2aA1e81Cd",
        ],
        ...
        okx: [
            ...
            "0x09f94b5Fc68e227C323A6FbaE3Bd98C97fD8c849",
...
const avalanche = makeConfig({
    ...
    marketRouters: {
        ...
        okx: [
            "0xa94Fcf9fc56a864f8DE51e6315aee5863AD63C91",
            "0xAB96dcFA7A7D669d9BF5918faB8641479973dD0A",
...
const bsc = makeConfig({
    ...
    marketRouters: {
        ...
        fabric: ["0x3A7f029E3ad003AB5Aa78ccf101b1B543eaed6F9"],
        fynd: [
            "0x712d0213439d99e56eFe5453253C12131C4019C9",
...
const hyperevm = makeConfig({
    ...
    marketRouters: {
        ...
        kyberswap: ["0x6131B5fae19EA4f9D964eAc0408E4408b66337b5"],
        okx: [
            "0x9Ac7b1FFEE0f58c0a3c89AA54Afb62efD25DC9fd",
            "0xb193874f0C77948d2bCFeC2EfAF8Bc65B4C2ca89",
            "0x56e6983D59bF472Ced0E63966A14d94A3A291589",
        ],
        openocean: ["0x6352a56caadC4F1E25CD6c75970Fa768A3304e64"],
        zeroex: [
            "0x0000000000001fF3684f28c67538d4D072C22734",
...
const mainnet = makeConfig({
    ...
    marketRouters: {
        ...
        fynd: [
            "0xea290cE3Eae57BdB37E57872a5a14DC0d2f6e614",
            "0x1644D2477f809cc2C71bCCFd6Dc9497E3F83210d",
        ],
...
const optimism = makeConfig({
    ...
    marketRouters: {
        ...
        okx: [
            ...
            "0x1f5B43127414E36c31eCb5Ff5567262997CD24D0",
        ],
        oneinch: ["0x111111125421ca6dc452d289314280a0f8842a65"],
        openocean: ["0x6352a56caadC4F1E25CD6c75970Fa768A3304e64"],
        paraswap: ["0x6A000F20005980200259B80c5102003040001068"],
        ...
        unizen: [
            ...
            "0xef58b643240178c2bc37681f8d4e50d7ec37ee22",
        ],
        zeroex: [
            "0x0000000000001fF3684f28c67538d4D072C22734",
...
const plasma = makeConfig({
    ...
    marketRouters: {
        ...
        kyberswap: ["0x6131B5fae19EA4f9D964eAc0408E4408b66337b5"],
        okx: [
            "0x19D345f95A80cc136d898f41b490E023cFF78658",
            "0xd72f9Af181A0eB1B8550a00124ECdb71Bb758C89",
...
const unichain = makeConfig({
    ...
    marketRouters: {
        enso: ["0xF75584eF6673aD213a685a1B58Cc0330B8eA22Cf"],
        fynd: [
            "0xa0498D0Fa4081c9a735b137a2E6A1910FaA0E0bC",
            "0xCba5574597Ad00EA250Fd106DAB4Fc7461949635",
        ],
        icecreamswap: ["0x3FFc2315A992b01dc4B3f79C8EEa1921091Ee24f"],
        kyberswap: ["0x6131B5fae19EA4f9D964eAc0408E4408b66337b5"],
        ...
        okx: [
            ...
            "0xe3dAb8Bf5187F9B4E8E89FF5414D7CF71E2C82e1",
        ],
        openocean: ["0x6352a56caadC4F1E25CD6c75970Fa768A3304e64"],
        paraswap: ["0x6A000F20005980200259B80c5102003040001068"],
...
function marketRouterEntries$1(chain, idx) {
    const routers = networkByAny$1(chain, idx).marketRouters;
    if (!routers)
        return [];
    const out = [];
    for (const [market, addresses] of Object.entries(routers)) {
        ...
        for (const address of addresses) {
            out.push({ market: market, address });
        }
    }
    return out;
}
function routersForMarket$1(chain, market, idx) {
    return networkByAny$1(chain, idx).marketRouters?.[market] ?? [];
}
function routerAllowlist$1(chain, idx) {
    return new Set(marketRouterEntries$1(chain, idx).map((e) => e.address.toLowerCase()));
}
function isAllowedRouter$1(chain, address, idx) {
    return routerAllowlist$1(chain, idx).has(address.toLowerCase());
}
function marketsForRouter$1(chain, address, idx) {
    const target = address.toLowerCase();
    return marketRouterEntries$1(chain, idx)
 ...
 * @throws {NetworkNotFoundError} if no matching chain is found
 */
function marketRouterEntries(chain) {
    return marketRouterEntries$1(chain, _idx);
}
/**
 ...
 * @throws {NetworkNotFoundError} if no matching chain is found
 */
function routersForMarket(chain, market) {
    return routersForMarket$1(chain, market, _idx);
}
/**
 ...
 * @throws {NetworkNotFoundError} if no matching chain is found
 */
function routerAllowlist(chain) {
    return routerAllowlist$1(chain, _idx);
}
/**
 ...
 * @throws {NetworkNotFoundError} if no matching chain is found
 */
function isAllowedRouter(chain, address) {
    return isAllowedRouter$1(chain, address, _idx);
}
/**
 ...
 * @throws {NetworkNotFoundError} if no matching chain is found
 */
function marketsForRouter(chain, address) {
    return marketsForRouter$1(chain, address, _idx);
}
/**
...
export { ALL_NETWORKS, ChainType, MAINNET_CHAINS, NON_EVM_CHAINS, NON_EVM_CHAIN_ID, NetworkNotFoundError, arbitrum, avalanche, base, bitcoin, blast, bob, boba, bsc, buildNetworkIndex, caip2Reference, celo, chainType, corn, etherlink, filecoin, formatCAIP2, fromCAIP2, gensyn, gnosis, goat, hemi, hyperevm, isAllowedRouter, isEvmChain, isNetworkType, isNonEvmChain, lens, lightlink, linea, lisk, mainnet, makeConfig, manta, mantle, marketRouterEntries, marketsForRouter, matchain, metal, monad, moonbeam, networkByAny, networkByCAIP2, networkById, networkByName, networkByString, nibiru, optimism, parseCAIP2, pharos, plasma, polygon, polygonZkEvm, redbelly, robinhood, ronin, rootstock, routerAllowlist, routersForMarket, saga, scroll, sei, sepolia, solana, sonic, taiko, telos, toCAIP2, tronShasta, unichain, worldchain, xdc, zcash, zerog, zkSync };
