...
export declare const MAINNET_CHAINS: readonly [Readonly<{
    ...
    marketRouters: {
        ...
        fynd: ("0x8A8Ba3973C84252BF7D357E4C0244b7EedB8B658" | "0x924F147c50eA59f5180a26031A8b65B2aA1e81Cd")[];
        ...
        okx: ("0x7CF6b330b437E9fb432B1400DE17B03357Cf049A" | "0x70cBb871E8f30Fc8Ce23609E9E0Ea87B6b222F58" | "0x09f94b5Fc68e227C323A6FbaE3Bd98C97fD8c849" | "0x9736d9a45115E33411390EbD54e5A5C3A6E25aA6")[];
    ...
    stables: ("0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8" | "0xaf88d065e77c8cc2239327c5edb3a432268e5831" | "0xfd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9" | "0xda10009cbd5d07dd0cecc66161fc93d7c9000da1")[];
    ...
    marketRouters: {
        ...
        fynd: ("0x9bA632d83e9eF57571256Cf4cc951b8aF1158e9C" | "0xAbA5B53b03eAfaD1C5fc8BD5Fc765fC85Bb3de67")[];
        icecreamswap: "0xC87De04e2EC1F4282dFF2933A2D58199f688fC3d"[];
        kyberswap: "0x6131B5fae19EA4f9D964eAc0408E4408b66337b5"[];
        native: "0xaEC634d949df14Be76dC317504C7b9a6a8A5f576"[];
        odos: ("0x19cEeAd7105607Cd444F5ad10dd51356436095a1" | "0x0d05a7d3448512b78fa8a9e46c4872c88c4a0d05")[];
        okx: ("0xC8F6b8Ba0DC0f175B568B99440B0867F69A29265" | "0x57df6092665eb6058DE53939612413ff4B09114E" | "0x67d03631FE51B741C0C00c4E16eb662AC84381df" | "0x77449Ff075C0A385796Da0762BCB46fd5cc884c6")[];
        oneinch: "0x111111125421ca6dc452d289314280a0f8842a65"[];
        openocean: "0x6352a56caadC4F1E25CD6c75970Fa768A3304e64"[];
        paraswap: "0x6A000F20005980200259B80c5102003040001068"[];
    ...
    marketRouters: {
        ...
        enso: "0xF75584eF6673aD213a685a1B58Cc0330B8eA22Cf"[];
        fabric: "0x3A7f029E3ad003AB5Aa78ccf101b1B543eaed6F9"[];
        fynd: ("0x712d0213439d99e56eFe5453253C12131C4019C9" | "0x7f3D12BBaFb8955E51B3ab9588b34c8ad95BDA4e")[];
        icecreamswap: "0x1a3304cBef66de00FbE1548CC4C6585aD22FbCFf"[];
        kyberswap: "0x6131B5fae19EA4f9D964eAc0408E4408b66337b5"[];
        native: "0xF064b069Ed18Eb5c61159247C55C5af79B28a968"[];
        odos: ("0x89b8AA89FDd0507a99d334CBe3C808fAFC7d850E" | "0x0D05a7D3448512B78fa8A9e46c4872C88C4a0D05")[];
        okx: ("0x62cceF0b4545166f721cAa9fEe13c1d3767E27dc" | "0x2c34A2Fb1d0b4f55de51E1d0bDEfaDDce6b7cDD6" | "0x5994814f2C4040b863A0125A45DE152a8c2A4DEc" | "0x5cb43Bae4f36E2f9f858232B4Dce0dbE27bb85e3")[];
        oneinch: "0x111111125421ca6dc452d289314280a0f8842a65"[];
        openocean: "0x6352a56caadC4F1E25CD6c75970Fa768A3304e64"[];
        paraswap: "0x6A000F20005980200259B80c5102003040001068"[];
    ...
    marketRouters: {
        binance: "0xB44446b0c8E56988c34f7Ff73Ae904982b5FdDA5"[];
        enso: "0xF75584eF6673aD213a685a1B58Cc0330B8eA22Cf"[];
        icecreamswap: ("0xa575f37e869e6887564F87c07e2885e08D542C4a" | "0xC87De04e2EC1F4282dFF2933A2D58199f688fC3d")[];
        kyberswap: "0x6131B5fae19EA4f9D964eAc0408E4408b66337b5"[];
        odos: ("0x0d05a7d3448512b78fa8a9e46c4872c88c4a0d05" | "0xCa423977156BB05b13A2BA3b76Bc5419E2fE9680")[];
        okx: ("0xDd5E9B947c99Aa60bab00ca4631Dce63b49983E7" | "0x68D6B739D2020067D1e2F713b999dA97E4d54812" | "0x1f5B43127414E36c31eCb5Ff5567262997CD24D0")[];
        oneinch: "0x111111125421ca6dc452d289314280a0f8842a65"[];
        openocean: "0x6352a56caadC4F1E25CD6c75970Fa768A3304e64"[];
        paraswap: "0x6A000F20005980200259B80c5102003040001068"[];
        ...
        unizen: ("0xef58b643240178c2bc37681f8d4e50d7ec37ee22" | "0xad1d43efcf92133a9a0f33e5936f5ca10f2b012e")[];
        zeroex: ("0x0000000000001fF3684f28c67538d4D072C22734" | "0x8CF38ec1BB723e6B948442Dc604b35a54D3Dc893" | "0x98c43b751ff87b4dd0bc3b7aabef66c230c08445" | "0xdef1abe32c034e558cdd535791643c58a13acc10")[];
    };
    bridges: {
        cctp: {
            domain: number;
    ...
    marketRouters: {
        ...
        bitget: "0xBc1D9760bd6ca468CA9fB5Ff2CFbEAC35d86c973"[];
        enso: "0xF75584eF6673aD213a685a1B58Cc0330B8eA22Cf"[];
        fynd: ("0x0C85409014d6c8cAEF60C837198c931246BD6296" | "0xbd4e6011F03355C2A377Fd9Af939322A7d0A1bC1")[];
        icecreamswap: "0x99bA7d569EA69671B399A7cC488b687515F7EC23"[];
        kyberswap: "0x6131B5fae19EA4f9D964eAc0408E4408b66337b5"[];
        odos: "0x4E3288c9ca110bCC82bf38F09A7b425c095d92Bf"[];
        okx: ("0xF6E1B4b201e220FC3741bd7a75675ffEA25c02AD" | "0x3B86917369B83a6892f553609F3c2F439C184e31" | "0x3C4829196BFadFF4394726b45159aeaAC6FCd41c")[];
        oneinch: "0x111111125421ca6dc452d289314280a0f8842a65"[];
        openocean: "0x6352a56caadC4F1E25CD6c75970Fa768A3304e64"[];
        paraswap: "0x6A000F20005980200259B80c5102003040001068"[];
    ...
    stables: ("0x2791bca1f2de4661ed88a30c99a7a9449aa84174" | "0x3c499c542cef5e3811e1192ce70d8cc03d5c3359" | "0x8f3cf7ad23cd3cadbd9735aff958023239c6a063" | "0xc2132d05d31c914a87c6611c10748aeb04b58e8f")[];
    ...
    marketRouters: {
        ...
        okx: ("0x57df6092665eb6058DE53939612413ff4B09114E" | "0xcF76984119C7f6ae56fAfE680d39C08278b7eCF4" | "0x472fc4f7fd3C9F06f0b8637c5505815ac80938Ad")[];
        openocean: "0x6352a56caadC4F1E25CD6c75970Fa768A3304e64"[];
    ...
    marketRouters: {
        ...
        openocean: "0x6352a56caadC4F1E25CD6c75970Fa768A3304e64"[];
        uniswap: ("0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45" | "0x8B844f885672f333Bc0042cB669255f93a4C1E6b")[];
    };
    bridges: {
        chainlink: {
            atlasNetworkName: string;
    ...
    marketRouters: {
        ...
        icecreamswap: "0xC87De04e2EC1F4282dFF2933A2D58199f688fC3d"[];
        kyberswap: "0x6131B5fae19EA4f9D964eAc0408E4408b66337b5"[];
        okx: ("0x19D345f95A80cc136d898f41b490E023cFF78658" | "0xd72f9Af181A0eB1B8550a00124ECdb71Bb758C89" | "0x9FD43F5E4c24543b2eBC807321E58e6D350d6a5A")[];
        openocean: "0x6352a56caadC4F1E25CD6c75970Fa768A3304e64"[];
        uniswap: ("0x807F4E281B7A3B324825C64ca53c69F0b418dE40" | "0x1b35fbA9357fD9bda7ed0429C8BbAbe1e8CC88fc")[];
    ...
    watchlist: ("0x5c1e4669c5208adc0163273d51928890b663237f" | "0xb5cb173dc8f8e8379343d12faa0cd66cb2db7d2e" | "0x5B7698191ac6f42F8AA1B42EC8ce535E63423F67" | "0xce77377cdfeb967ff2bb6f223ae74e1ae8dcfc71" | "0xf0766611cb1288186f74f401fdb5e606c4b23693" | "0x362452a081e028d1ed4f43fa3329890d79526309")[];
    v4Watchlist: never[];
    internalName: "zerog";
    ...
    marketRouters: {
        enso: "0xCfBAa9Cfce952Ca4F4069874fF1Df8c05e37a3c7"[];
        fabric: "0x3A7f029E3ad003AB5Aa78ccf101b1B543eaed6F9"[];
        fynd: ("0x345e48768a65Ae596ac6A2Aee71202753C4866F5" | "0x09215a470bD585E59EB3F4B612fBD2678131fF9e")[];
        icecreamswap: "0x603206D6105217DD972E4Ab30676A220CA393346"[];
        kyberswap: "0x6131B5fae19EA4f9D964eAc0408E4408b66337b5"[];
        native: "0xa5ec1f0aC784C3620fFDcdf2A7DbcEF9DA658ea4"[];
        okx: ("0xE58b3089dF6667fBf99b75595a1671BaF6797D6d" | "0x6e2A35A7AD683cF634D91492d73bb7FF774c6919" | "0x42170295F1173c9e5874ea9d00c6d137E1a4f53d")[];
        openocean: "0x6352a56caadC4F1E25CD6c75970Fa768A3304e64"[];
