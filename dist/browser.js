(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('viem'), require('viem/chains')) :
  typeof define === 'function' && define.amd ? define(['exports', 'viem', 'viem/chains'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["oku-chains"] = {}, global.viem, global.chains));
})(this, (function (exports, viem, chains) { 'use strict';
  ...
  const arbitrum = makeConfig({
      ...
      uniswap: {
          deployBlock: 165,
          poolFactory: viem.getAddress("0x1F98431c8aD98523631AE4a59f267346ea31F984"),
          multicall2: viem.getAddress("0x5BA1e12693Dc8F9c48aAD8770482f4739bEeD696"),
          proxyAdmin: viem.getAddress("0xB753548F6E010e7e680BA186F9Ca1BdAB2E90cf2"),
          tickLens: viem.getAddress("0xbfd8137f7d1516D3ea5cA83523914859ec47F573"),
          quoter: viem.getAddress("0xb27308f9F90D607463bb33eA1BeBb41C27CE5AB6"),
          swapRouter: viem.getAddress("0xE592427A0AEce92De3Edee1F18E0157C05861564"),
          swapRouter02: viem.getAddress("0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45"),
          NFTDescriptor: viem.getAddress("0x42B24A95702b9986e82d421cC3568932790A48Ec"),
          nonfungibleTokenPositionDescriptor: viem.getAddress("0x91ae842A5Ffd8d12023116943e72A606179294f3"),
          transparentUpgradeableProxy: viem.getAddress("0xEe6A57eC80ea46401049E92587E52f5Ec1c24785"),
          nonfungiblePositionManager: viem.getAddress("0xC36442b4a4522E871399CD717aBDD847Ab11FE88"),
          v3Migrator: viem.getAddress("0xA5644E29708357803b5A882D272c41cC0dF92B34"),
          uniswapV3Staker: viem.getAddress("0xe34139463bA50bD61336E0c446Bd8C0867c6fE65"),
          positionsNFT: viem.getAddress("0xC36442b4a4522E871399CD717aBDD847Ab11FE88"),
          topNativePool: viem.getAddress("0x88e6a0c2ddd26feeb64f039a2c41296fcb3f5640"),
      ...
      oku: {
          ...
          pricing: {
              ...
              nativeQuotePools: [
                  {
                      deployBlock: 100909,
                      pool: viem.getAddress("0xc31e54c7a869b9fcbecc14363cf510d1c41fa443"),
                  },
              ],
              stablecoinList: [
  ...
  const base = makeConfig({
      ...
      uniswap: {
          deployBlock: 1371680,
          poolFactory: viem.getAddress("0x33128a8fC17869897dcE68Ed026d694621f6FDfD"),
          multicall2: viem.getAddress("0x091e99cb1C49331a94dD62755D168E941AbD0693"),
          tickLens: viem.getAddress("0x0CdeE061c75D43c82520eD998C23ac2991c9ac6d"),
          nonfungiblePositionManager: viem.getAddress("0x03a520b32C04BF3bEEf7BEb72E919cf822Ed34f1"),
          positionsNFT: viem.getAddress("0x03a520b32C04BF3bEEf7BEb72E919cf822Ed34f1"),
          positionsNFTDeployBlock: 1371714,
      },
      token: {
          usdcAddress: viem.getAddress("0x833589fcd6edb6e08f4c7c32d4f71b54bda02913"),
      },
      oku: {
          pricing: {
  ...
  const boba = makeConfig({
      ...
      uniswap: {
          deployBlock: 969351,
          poolFactory: viem.getAddress("0xFFCd7Aed9C627E82A765c3247d562239507f6f1B"),
          multicall2: viem.getAddress("0xd213Ff319F8d28Fe31EbDB75b23aA61a2b905320"),
          proxyAdmin: viem.getAddress("0xE8B5DaE430189ea6ccffF4eEeC58a98556525fB4"),
          tickLens: viem.getAddress("0x36EBd44350E4406E67C5579026950793b8528402"),
          quoter: viem.getAddress("0x483fc90DDC7aC847D4a752055DCF73483B6d97FD"),
          swapRouter02: viem.getAddress("0x759E8B0cb9d65291e258aE3e043258ae1dD0df16"),
          NFTDescriptor: viem.getAddress("0x531c3B226288854e992150FEfF4d95F7B8DEbD8c"),
          nonfungibleTokenPositionDescriptor: viem.getAddress("0xb6751A274EDAe02A911E3bB23682FAaF380433b7"),
          transparentUpgradeableProxy: viem.getAddress("0xEe6A57eC80ea46401049E92587E52f5Ec1c24785"),
          nonfungiblePositionManager: viem.getAddress("0x0bfc9aC7E52f38EAA6dC8d10942478f695C6Cf71"),
          v3Migrator: viem.getAddress("0x9ab1E646877732DD76bd662DC242723D7e4B42ba"),
          uniswapV3Staker: viem.getAddress("0x6a6c1198f85B084822138DFd3fA9686e4029c091"),
          positionsNFT: viem.getAddress("0x0bfc9aC7E52f38EAA6dC8d10942478f695C6Cf71"),
      ...
      contracts: {
          ...
          multicall2: {
              address: viem.getAddress("0x07956092c0F4818D6792a42035d2d2fa0C75E76B"),
          },
          multicall3: {
              address: viem.getAddress("0xcA11bde05977b3631167028862bE2a173976CA11"),
          },
      },
  });
  ...
  const filecoin = makeConfig({
      ...
      uniswap: {
          deployBlock: 3195837,
          poolFactory: viem.getAddress("0xB4C47eD546Fc31E26470a186eC2C5F19eF09BA41"),
          multicall2: viem.getAddress("0x732f5baac411e427d130fed03c2e82a3e0d64d35"),
          tickLens: viem.getAddress("0x76c001ad9E527FEfA8Fa822a987Ad44ce720BAeD"),
          nonfungiblePositionManager: viem.getAddress("0x4cd986dD509fbB6A695aE971d5C56c8795f640ee"),
          positionsNFT: viem.getAddress("0x4cd986dD509fbB6A695aE971d5C56c8795f640ee"),
  ...
  const mainnet = makeConfig({
      ...
      oku: {
          ...
          pricing: {
              ...
              stablecoinList: [
                  viem.getAddress("0x6B175474E89094C44Da98b954EedeAC495271d0F"),
                  viem.getAddress("0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"),
                  viem.getAddress("0xdAC17F958D2ee523a2206206994597C13D831ec7"),
                  viem.getAddress("0x0000000000085d4780B73119b644AE5ecd22b376"),
                  viem.getAddress("0x57Ab1ec28D129707052df4dF418D58a2D46d5f51"),
                  viem.getAddress("0x956f47f50a910163d8bf957cf5846d573e7f87ca"),
                  viem.getAddress("0x4Fabb145d64652a948d72533023f6E7A623C7C53"),
                  viem.getAddress("0x853d955acef822db058eb8505911ed77f175b99e"),
                  viem.getAddress("0x8E870D67F660D95d5be530380D0eC0bd388289E1"),
                  viem.getAddress("0x5f98805A4E8be255a32880FDeC7F6728C6568bA0"),
                  viem.getAddress("0x99d8a9c45b2eca8864373a26d1459e3dff1e17f3"),
              ],
              pools: [
                  viem.getAddress("0x88e6a0c2ddd26feeb64f039a2c41296fcb3f5640"),
                  viem.getAddress("0x11b815efb8f581194ae79006d24e0d814b7697f6"),
                  viem.getAddress("0x60594a405d53811d3bc4766596efd80fd545a270"),
                  viem.getAddress("0x3416cf6c708da44db2624d63ea0aaef7113527c6"),
                  viem.getAddress("0x8ad599c3a0ff1de082011efddc58f1908eb6e6d8"),
                  viem.getAddress("0x4e68ccd3e89f51c3074ca5072bbac773960dfa36"),
                  viem.getAddress("0x69d91b94f0aaf8e8a2586909fa77a5c2c89818d5"),
                  viem.getAddress("0x7858e59e0c01ea06df3af3d20ac7b0003275d4bf"),
                  viem.getAddress("0xe0554a476a092703abdb3ef35c80e0d76d32939f"),
                  viem.getAddress("0x5777d92f208679db4b9778590fa3cab3ac9e2168"),
                  viem.getAddress("0xc2e9f25be6257c210d7adf0d4cd6e3e881ba25f8"),
                  viem.getAddress("0x99ac8ca7087fa4a2a1fb6357269965a2014abc35"),
                  viem.getAddress("0x6c6bc977e13df9b0de53b251522280bb72383700"),
                  viem.getAddress("0x9a772018fbd77fcd2d25657e5c547baff3fd7d16"),
                  viem.getAddress("0x6f48eca74b38d2936b02ab603ff4e36a6c0e3a77"),
                  viem.getAddress("0xe859041c9c6d70177f83de991b9d757e13cea26e"),
                  viem.getAddress("0x3328ca5b535d537f88715b305375c591cf52d541"),
                  viem.getAddress("0x353bb62ed786cdf7624bd4049859182f3c1e9e5d"),
                  viem.getAddress("0x9a834b70c07c81a9fcd6f22e842bf002fbffbe4d"),
                  viem.getAddress("0x9db9e0e53058c89e5b94e29621a205198648425b"),
                  viem.getAddress("0xb07fe2f407f971125d4eb1977f8acee8846c7324"),
                  viem.getAddress("0x84383fb05f610222430f69727aa638f8fdbf5cc1"),
                  viem.getAddress("0xb0f4a77bde7fee134265307c5cc19abff0ba409b"),
                  viem.getAddress("0xc63b0708e2f7e69cb8a1df0e1389a98c35a76d52"),
                  viem.getAddress("0x92ab871abb9d567aa276b2ce58d0203d84e0181e"),
                  viem.getAddress("0x735a26a57a0a0069dfabd41595a970faf5e1ee8b"),
                  viem.getAddress("0x7bea39867e4169dbe237d55c8242a8f2fcdcc387"),
                  viem.getAddress("0x5e35c4eba72470ee1177dcb14dddf4d9e6d915f4"),
                  viem.getAddress("0x07a6e955ba4345bae83ac2a6faa771fddd8a2011"),
                  viem.getAddress("0xfad57d2039c21811c8f2b5d5b65308aa99d31559"),
                  viem.getAddress("0xd0fc8ba7e267f2bc56044a7715a489d851dc6d78"),
                  viem.getAddress("0x8c54aa2a32a779e6f6fbea568ad85a19e0109c26"),
                  viem.getAddress("0xe05e653453f733786f2dabae0ffa1e96cfcc4b25"),
                  viem.getAddress("0x094a28b22e1b4218d590ea6fa916b3c5e670ba55"),
                  viem.getAddress("0xdd005650ac6805457f4fa6ee1816813ce815e914"),
                  viem.getAddress("0x015769601d8d4879c0e193eeab31f10cf03c9ea9"),
                  viem.getAddress("0xc5af84701f98fa483ece78af83f11b6c38aca71d"),
                  viem.getAddress("0x48da0965ab2d2cbf1c17c09cfb5cbe67ad5b1406"),
                  viem.getAddress("0x4e0924d3a751be199c426d52fb1f2337fa96f736"),
                  viem.getAddress("0x94b4ba66da4faa4fe09e17c0a8810d2afee70163"),
                  viem.getAddress("0x92995d179a5528334356cb4dc5c6cbb1c068696c"),
                  viem.getAddress("0x18d96b617a3e5c42a2ada4bc5d1b48e223f17d0d"),
                  viem.getAddress("0x9febc984504356225405e26833608b17719c82ae"),
                  viem.getAddress("0x2cb162433e0cabac4825e6d198a125829156cc92"),
                  viem.getAddress("0xc2a856c3aff2110c1171b8f942256d40e980c726"),
                  viem.getAddress("0x6279653c28f138c8b31b8a0f6f8cd2c58e8c1705"),
                  viem.getAddress("0x97e7d56a0408570ba1a7852de36350f7713906ec"),
                  viem.getAddress("0x216fb666dd61600e74f7b2ca25a38aa99db1a4e9"),
                  viem.getAddress("0x7270233ccae676e776a659affc35219e6fcfbb10"),
                  viem.getAddress("0xff29d3e552155180809ea3a877408a4620058086"),
                  viem.getAddress("0xcb0c5d9d92f4f2f80cce7aa271a1e148c226e19d"),
                  viem.getAddress("0x486263aa56d1b49d78dea765754164b880c99954"),
                  viem.getAddress("0x25c0edc51909fc20429c6ece9b8f4fbb5af13878"),
                  viem.getAddress("0x14036bbda496e39dc3db6025fe858431c1ddadb1"),
                  viem.getAddress("0x16980c16811bde2b3358c1ce4341541a4c772ec9"),
                  viem.getAddress("0xdf50fbde8180c8785842c8e316ebe06f542d3443"),
                  viem.getAddress("0x298b7c5e0770d151e4c5cf6cca4dae3a3ffc8e27"),
                  viem.getAddress("0x3aaf77ba7da262e34dffb9b10fc6777bfda79ab7"),
                  viem.getAddress("0xd6a309f49cf79542cea91df7b334eb4bd29aa0d7"),
                  viem.getAddress("0xdb02d6827220475ece91893255fdf57bed51aee3"),
                  viem.getAddress("0xa19f4ebe4cbb3c9b57c16eb4dfc7a52d46a5e891"),
                  viem.getAddress("0x6c4ab1907805adcb0b7ae911a5d1b0b99d608b3c"),
                  viem.getAddress("0x19f83460e387f1b01f94b85c2532ebc15b0b712e"),
                  viem.getAddress("0xaae63df9a86f9a682507c922db38fae5e777a606"),
                  viem.getAddress("0x7ec0b75a98997c927ace6d87958147a105147ea0"),
                  viem.getAddress("0x868b7bbbfe148516e5397f23982923686182c2d2"),
                  viem.getAddress("0xd73ea444eef6faf5423b49be3448e94ed214f1ec"),
                  viem.getAddress("0xbb2e5c2ff298fd96e166f90c8abacaf714df14f8"),
                  viem.getAddress("0x1a349a3397a8431eed8d94a05f88f9001117fcaa"),
                  viem.getAddress("0x85b5a7dc1630f9465d8409e2ac53313b70a71b9c"),
                  viem.getAddress("0x3067c3054b4a605f9e327bad82d9ba6049fe76a0"),
                  viem.getAddress("0x00cef0386ed94d738c8f8a74e8bfd0376926d24c"),
                  viem.getAddress("0x75bff91af9878f5ec3fede9b52d51159afc2430a"),
                  viem.getAddress("0xa5ef2a6bbe8852bd6fd2ef6ab9bb45081a6f531c"),
                  viem.getAddress("0xb06e7ed37cfa8f0f2888355dd1913e45412798c5"),
                  viem.getAddress("0xfe0df74636bc25c7f2400f22fe7dae32d39443d2"),
                  viem.getAddress("0x07f3d316630719f4fc69c152f397c150f0831071"),
                  viem.getAddress("0x38b6e47a97f4680a983eadc8e510c37d73967c29"),
                  viem.getAddress("0xd3ca35355106cb8bc5fd7c534275509673319d83"),
                  viem.getAddress("0x020c349a0541d76c16f501abc6b2e9c98adae892"),
                  viem.getAddress("0x9275e26bfb23b18bebb07bff45e85110f60963e9"),
                  viem.getAddress("0xd5ad5ec825cac700d7deafe3102dc2b6da6d195d"),
                  viem.getAddress("0x537a0a5654045c52ec45c4c86ed0c1ffe893809d"),
                  viem.getAddress("0xc4d9c69962ddb2388e1532279704fc6eb199c963"),
                  viem.getAddress("0x813b22032e94667cc0f854cc7241fc5a309c45bc"),
                  viem.getAddress("0xe081eeab0adde30588ba8d5b3f6ae5284790f54a"),
                  viem.getAddress("0x5c28b5f471d97f53fcf132f16f9f3c0c888c1a01"),
                  viem.getAddress("0x9445bd19767f73dcae6f2de90e6cd31192f62589"),
                  viem.getAddress("0xa80964c5bbd1a0e95777094420555fead1a26c1e"),
                  viem.getAddress("0xb8c05b7ca698f7cfd9b8a08f177e0ac5f2696bf9"),
                  viem.getAddress("0xd0af1981f52146a6939385451daea0726e13a484"),
                  viem.getAddress("0xa109209a2380fd4454b0364c4689f6de18ad18cc"),
                  viem.getAddress("0x5f3c621d810c7c929fb440e03dadf8621fe61ab5"),
                  viem.getAddress("0x141df9a608856d1651c9a3c27b39960ff0418a12"),
                  viem.getAddress("0x08f68110f1e0ca67c80a24b4bd206675610f445d"),
                  viem.getAddress("0x39529e96c28807655b5856b3d342c6225111770e"),
                  viem.getAddress("0x391e8501b626c623d39474afca6f9e46c2686649"),
                  viem.getAddress("0xbe3cd9b751360a8030770425acf947c8cb4cab38"),
                  viem.getAddress("0xbd5fdda17bc27bb90e37df7a838b1bfc0dc997f5"),
                  viem.getAddress("0x3470447f3cecffac709d3e783a307790b0208d60"),
              ],
          },
      },
  ...
  const moonbeam = makeConfig({
      ...
      uniswap: {
          deployBlock: 3340452,
          poolFactory: viem.getAddress("0x28f1158795A3585CaAA3cD6469CD65382b89BB70"),
          multicall2: viem.getAddress("0xd213Ff319F8d28Fe31EbDB75b23aA61a2b905320"),
          tickLens: viem.getAddress("0x1f4F7b041895D9eB1A79be0896AF3E68e4160010"),
          quoter: viem.getAddress("0x48af91cdcad8ffdd7a8d4cdf73c16cb0632d3d17"),
          swapRouter02: viem.getAddress("0xc507e22ba3140dc0a79fdf27e03c98aa20f3ee66"),
          NFTDescriptor: viem.getAddress("0x041b81cb4d223d8e70ac96c0d103f8a956ed4514"),
          nonfungibleTokenPositionDescriptor: viem.getAddress("0x921c55AE486e63D16dbfbE216573A21aeB684c02"),
          transparentUpgradeableProxy: viem.getAddress("0xEe6A57eC80ea46401049E92587E52f5Ec1c24785"),
          nonfungiblePositionManager: viem.getAddress("0x0bfc9aC7E52f38EAA6dC8d10942478f695C6Cf71"),
          v3Migrator: viem.getAddress("0x76776b10d782a1d194fbfc92d4b01db1ce1eeb4b"),
          positionsNFT: viem.getAddress("0x9036D0DcB5a059C9371B05D508f0072Df773854e"),
  ...
  const polygon = makeConfig({
      ...
      uniswap: {
          ...
          poolFactory: viem.getAddress("0x1F98431c8aD98523631AE4a59f267346ea31F984"),
          multicall2: viem.getAddress("0xca11bde05977b3631167028862be2a173976ca11"),
          proxyAdmin: viem.getAddress("0xB753548F6E010e7e680BA186F9Ca1BdAB2E90cf2"),
          tickLens: viem.getAddress("0xbfd8137f7d1516D3ea5cA83523914859ec47F573"),
          quoter: viem.getAddress("0xb27308f9F90D607463bb33eA1BeBb41C27CE5AB6"),
          swapRouter: viem.getAddress("0xE592427A0AEce92De3Edee1F18E0157C05861564"),
      ...
      oku: {
          ...
          pricing: {
              ...
              pools: [
                  viem.getAddress("0xa374094527e1673a86de625aa59517c5de346d32"),
                  viem.getAddress("0x45dda9cb7c25131df268515131f647d726f50608"),
                  viem.getAddress("0x9b08288c3be4f62bbf8d1c20ac9c5e6f9467d8b7"),
                  viem.getAddress("0xeef1a9507b3d505f0062f2be9453981255b503c8"),
                  viem.getAddress("0xdac8a8e6dbf8c690ec6815e0ff03491b2770255d"),
                  viem.getAddress("0x5645dcb64c059aa11212707fbf4e7f984440a8cf"),
                  viem.getAddress("0x0a6c4588b7d8bd22cf120283b1fff953420c45f3"),
                  viem.getAddress("0x88f3c15523544835ff6c738ddb30995339ad57d6"),
                  viem.getAddress("0xbb98b3d2b18aef63a3178023a920971cf5f29be4"),
                  viem.getAddress("0x5f69c2ec01c22843f8273838d570243fd1963014"),
                  viem.getAddress("0x0e44ceb592acfc5d3f09d996302eb4c499ff8c10"),
                  viem.getAddress("0x67a9fe12fa6082d9d0203c84c6c56d3c4b269f28"),
                  viem.getAddress("0x04537f43f6add7b1b60cab199c7a910024ee0594"),
                  viem.getAddress("0x3f5228d0e7d75467366be7de2c31d0d098ba2c23"),
                  viem.getAddress("0x7de263d0ad6e5d208844e65118c3a02a9a5d56b6"),
                  viem.getAddress("0x254aa3a898071d6a2da0db11da73b02b4646078f"),
                  viem.getAddress("0x847b64f9d3a95e977d157866447a5c0a5dfa0ee5"),
                  viem.getAddress("0x0f663c16dd7c65cf87edb9229464ca77aeea536b"),
                  viem.getAddress("0x781067ef296e5c4a4203f81c593274824b7c185d"),
                  viem.getAddress("0x0a63d3910ffc1529190e80e10855c4216407cc45"),
                  viem.getAddress("0x4ccd010148379ea531d6c587cfdd60180196f9b1"),
                  viem.getAddress("0x94ab9e4553ffb839431e37cc79ba8905f45bfbea"),
                  viem.getAddress("0xfe530931da161232ec76a7c3bea7d36cf3811a0d"),
                  viem.getAddress("0x6488adfdbb85ce0302faa6ac72c8693eba81df83"),
                  viem.getAddress("0xdb11b39d8acdc877c58392e996a4a88424483705"),
                  viem.getAddress("0x16e7ca3eaaf7703b9724301e6fd3d4e2918fec59"),
                  viem.getAddress("0x3d0acd52ee4a9271a0ffe75f9b91049152bac64b"),
                  viem.getAddress("0x3165241b09823256465699625637d535d634cc8c"),
                  viem.getAddress("0x3bfcb475e528f54246f1847ec0e7b53dd88bda4e"),
                  viem.getAddress("0x4c0bc5d34369d5f89e7f3aa551150dc7d281b4c7"),
                  viem.getAddress("0x1cf0a4717f15ac0265d26986af8ac4ce25fd9a3f"),
                  viem.getAddress("0x3fa147d6309abeb5c1316f7d8a7d8bd023e0cd80"),
                  viem.getAddress("0x6bad0f9a89ca403bb91d253d385cec1a2b6eca97"),
                  viem.getAddress("0xb493e5aee0e0325632f4ed63cc889a23b8c77969"),
                  viem.getAddress("0x613e24ec04fa61a5967cccc90cdc1d9513f73d5a"),
                  viem.getAddress("0xb2f8ba544e4874d4e0f817359d0f4bcff209b87e"),
                  viem.getAddress("0x1edbf151b7a4bfb611030efcb460ae0d3516aee7"),
                  viem.getAddress("0x74d3c85df4dbd03c7c12f7649faa6457610e7604"),
                  viem.getAddress("0xbeaf7156ba07c3df8fac42e90188c5a752470db7"),
                  viem.getAddress("0xab4b63bd6c214ce8409fa1b31afa50d4e17597f9"),
                  viem.getAddress("0x26770cc2c612e5c97eb70a6531fa9d5098ef74ab"),
                  viem.getAddress("0x22177148e681a6ca5242c9888ace170ee7ec47bd"),
                  viem.getAddress("0xa1cfb393607d1a6888d273b762832ed14c8b56b1"),
                  viem.getAddress("0xa236278bec0e0677a48527340cfb567b4e6e9adc"),
                  viem.getAddress("0x156917664027312906a3e977e7f316a29934a37d"),
                  viem.getAddress("0x6cd22380745d4e4a5b674f692a1e84281e5e0896"),
                  viem.getAddress("0x286af3968aec55ec3acd463bf59edc7cbc04102e"),
                  viem.getAddress("0x42f0530351471dab7ec968476d19bd36af9ec52d"),
                  viem.getAddress("0x67e708986a809acefde16f2417fa5701241e3935"),
                  viem.getAddress("0x3e4bebfd2e3f6672640c83fc4888620741169825"),
                  viem.getAddress("0x33016df701b323c33cc027146c6a9e0997b2a923"),
                  viem.getAddress("0x30f5c777ab316e6878d2b71a32274e4c2842327a"),
                  viem.getAddress("0x78a750ca5f8dd1ef1c87e29e8a267ff4c8d12b38"),
                  viem.getAddress("0xfa22d298e3b0bc1752e5ef2849cec1149d596674"),
                  viem.getAddress("0x5884ddb0bb109c02150242edf00d0737d78ed61d"),
                  viem.getAddress("0x67b6ee9feab5fe2affed6a386950576d43f238dd"),
                  viem.getAddress("0x9159a880b930aced1080ed4742818362663c8d46"),
                  viem.getAddress("0xa90c1c009dc8292bd04ced30f9b53a5ff7a806a0"),
                  viem.getAddress("0x1f6082db7c8f4b199e17090cd5c8831a1dad1997"),
                  viem.getAddress("0xbd934a7778771a7e2d9bf80596002a214d8c9304"),
                  viem.getAddress("0xfc704de88db4858419d5d0af080486a95343ba15"),
                  viem.getAddress("0x32a222f69d00e717845a3d857d0392d6a25a2acd"),
                  viem.getAddress("0x7f567ce133b0b69458fc318af06eee27642865be"),
                  viem.getAddress("0x98349e1689538fd878646b77b3dcd89040a35eb6"),
                  viem.getAddress("0x6feae21e16097faa70afbb12872bdba3c85f4d9f"),
                  viem.getAddress("0xd0beb9570bc3d2af7fa461dfd3c75cc3a34f95e2"),
                  viem.getAddress("0x56fcb902bee19a645f9607cd1e1c0737b6358feb"),
                  viem.getAddress("0xe6617e2fb578e1df127f59fafeaa1122e543278f"),
                  viem.getAddress("0x08b446353ddb5a1695774bd547703879ff253aea"),
                  viem.getAddress("0xd67d3f77ad7acab1a75863b094176015df30cd8c"),
                  viem.getAddress("0xaa40be3a775451ddccf3aabf36bdea550391341f"),
                  viem.getAddress("0x0d1375f18e23099ae6a151e818cfe491b4feff31"),
                  viem.getAddress("0xf9e9526e55a0e1fac1813b2fe88bc9b30eea04f9"),
                  viem.getAddress("0xb69d18170a7d949777ead872cc6ba7cabb78fcfc"),
                  viem.getAddress("0xa708d430656aa379b6b0b1d570be8ae1095530e5"),
                  viem.getAddress("0xe93fde3c231c48db0a78e3d802afc55d845102c9"),
                  viem.getAddress("0x046bbdd927fc635dd6de7cf4efdad3e767274074"),
                  viem.getAddress("0xd06a93253d719ed8f28489ae9838d3d0f9eaba42"),
                  viem.getAddress("0xae732bd3d6becb4f0f458f54a6daad1fb1e9222c"),
                  viem.getAddress("0x039de30e4901793293a155dc3bcddc1b66fb5707"),
                  viem.getAddress("0x635fd65c546e66f73b7a760307ad884916f4c204"),
                  viem.getAddress("0x362d0401ed74db25219b6d02ac1791cfe3542d68"),
                  viem.getAddress("0x0581ef32b9393c5c282517282853267eed69621e"),
                  viem.getAddress("0x802c9f216f812b1a4b24636bec4f261b316797cb"),
                  viem.getAddress("0xc1dc5605b242a658adfc7d6e693a50aefb49bbae"),
                  viem.getAddress("0xba0216254163b57af68b7161cf824dbadcad61df"),
                  viem.getAddress("0x90e883972ebcbebc871f3f0658bab1821b8e8705"),
                  viem.getAddress("0xba91ae7312ace1137c15786177cbe687fd2d73d0"),
                  viem.getAddress("0x140ae14be4b5e86aa149f76e84953746e0bc04f1"),
                  viem.getAddress("0x2b5c2a5558bcc428ca97c6a6cd0eac8c1d180d65"),
                  viem.getAddress("0x6c8408f735c2f73b8f9271f663b1540bb8c2acce"),
                  viem.getAddress("0xa846934be7302304f2a8e5b92b576a3cfe655002"),
                  viem.getAddress("0xc21b964af2b0254580d44981d624335f2b7c6fb6"),
                  viem.getAddress("0x0dab5aedaf25201cce638b9d617d4b8c23d29b8d"),
                  viem.getAddress("0x30fe5e402139925634430eb88e9c209e4a2d6dec"),
                  viem.getAddress("0x9a72fc3fb9e99087d2eae500355e7902c763f9b3"),
                  viem.getAddress("0x02d07784818ada64827fce9f5c1309af688a5681"),
                  viem.getAddress("0x5e575a7050ca806248e8f4341601847fde52d9ba"),
                  viem.getAddress("0x80c5c7d7e94158fd2daac56734889a7cdf8dadfe"),
                  viem.getAddress("0xd48cb7ad6a0e2137ea81803c63d2863206ce4700"),
              ],
          },
      },
      ...
      contracts: {
          ...
          multicall2: {
              address: viem.getAddress("0x275617327c958bD06b5D6b871E7f491D76113dd8"),
          },
          multicall3: {
              address: viem.getAddress("0xcA11bde05977b3631167028862bE2a173976CA11"),
          },
  ...
  const rootstock = makeConfig({
      ...
      uniswap: {
          deployBlock: 5829210,
          poolFactory: viem.getAddress("0xaF37EC98A00FD63689CF3060BF3B6784E00caD82"),
          multicall2: viem.getAddress("0x996a9858cdFa45aD68E47C9a30A7201E29c6A386"),
          tickLens: viem.getAddress("0x55B9dF5bF68ADe972191a91980459f48ecA16afC"),
          nonfungiblePositionManager: viem.getAddress("0x9d9386c042F194B460Ec424a1e57ACDE25f5C4b1"),
          positionsNFT: viem.getAddress("0x9d9386c042F194B460Ec424a1e57ACDE25f5C4b1"),
      ...
      contracts: {
          ...
          Multicall2: {
              address: viem.getAddress("0x996a9858cdFa45aD68E47C9a30A7201E29c6A386"),
          },
          Multicall3: {
              address: viem.getAddress("0xca11bde05977b3631167028862be2a173976ca11"),
          },
  ...
  const scroll = makeConfig({
      ...
      uniswap: {
          deployBlock: 1367,
          poolFactory: viem.getAddress("0x70C62C8b8e801124A4Aa81ce07b637A3e83cb919"),
          positionsNFT: viem.getAddress("0xB39002E4033b162fAc607fc3471E205FA2aE5967"),
      },
      token: {
      ...
      contracts: {
          ...
          Multicall2: {
              address: viem.getAddress("0x3b615B1AC55bc34e51a81D3dea67467F32bcb8C2"),
          },
          Multicall3: {
              address: viem.getAddress("0xcA11bde05977b3631167028862bE2a173976CA11"),
          },
  ...
  const polygonZkEvm = makeConfig({
      ...
      uniswap: {
          deployBlock: 8466867,
          poolFactory: viem.getAddress("0xff83c3c800Fec21de45C5Ec30B69ddd5Ee60DFC2"),
          multicall2: viem.getAddress("0x9073E304a15b1522132848B461857cd8BA932ea7"),
          tickLens: viem.getAddress("0x64519b94A7248Bf17929fB03b9648ce277Fd7fDA"),
          nonfungiblePositionManager: viem.getAddress("0xf0D61Aeda516CCa1FF20Be65Cfb0213be688A24f"),
          positionsNFT: viem.getAddress("0xf0D61Aeda516CCa1FF20Be65Cfb0213be688A24f"),
      ...
      oku: {
          limitOrderRegistry: viem.getAddress("0x5f1ef1d278013567c3c67e18d2d35bfa9954f723"),
      ...
      contracts: {
          ...
          multicall2: {
              address: viem.getAddress("0x1FaE28D9C07a8a96E2ECc53BB328E787D5B88674"),
          },
          multicall3: {
              address: viem.getAddress("0xca11bde05977b3631167028862be2a173976ca11"),
          },
  ...
  const zkSync = makeConfig({
      ...
      uniswap: {
          ...
          poolFactory: viem.getAddress("0x8FdA5a7a8dCA67BBcDd10F02Fa0649A937215422"),
          multicall2: viem.getAddress("0x0c68a7C72f074d1c45C16d41fa74eEbC6D16a65C"),
          tickLens: viem.getAddress("0xe10FF11b809f8EE07b056B452c3B2caa7FE24f89"),
          nonfungiblePositionManager: viem.getAddress("0x0616e5762c1E7Dc3723c50663dF10a162D690a86"),
          positionsNFT: viem.getAddress("0x0616e5762c1E7Dc3723c50663dF10a162D690a86"),
      ...
      contracts: {
          ...
          multicall2: {
              address: viem.getAddress("0x8bB86A31795d3e8ef12c630C288770e13eEcF038"),
          },
          multicall3: {
              address: viem.getAddress("0xF9cda624FBC7e059355ce98a31693d299FACd963"),
          },
      },
  });
